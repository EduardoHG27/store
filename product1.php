	      ...
	      <section class="content">
	        <div class="row">
	        	<div class="col-md-10">
	        		...
	        		<div class="alert alert-primary" id="callout" style="display:none">
  ...
  <div class="swiper-wrapper">
    <div class="swiper-slide easyzoom easyzoom--overlay">
      <a href="https://github.com/shoha-kh/products-gallery-carousel-with-zoom/blob/master/images/nature-1.jpg?raw=true">
        <img src="<?php echo (!empty($product['photo'])) ? 'images/'.$product['photo'] : 'images/noimage.jpg'; ?>" width="100%" class="zoom" data-magnify-src="images/large-<?php echo $product['photo']; ?>" alt=""/>
      </a>
    </div>
    <div class="swiper-slide easyzoom easyzoom--overlay">
		            			...
		            			<div class="field">
			            			<div class="container">
			            				...
			            				<span class="input-group-btn">
			            					<button type="button" id="minus" class="btn btn-outline-info btn-sm"><i class="fa fa-minus"></i></button>
			            				</span>
							          	<input type="text" name="quantity" id="quantity" class="input is-primary is-small" value="1" readonly>
							            <span class="input-group-btn">
							                <button type="button" id="add" class="btn btn-outline-success btn-sm"><i class="fa fa-plus"></i></button>
							            </span>
